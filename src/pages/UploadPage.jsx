...
//   // ---------------- CREATE PDF ----------------
//   const createPDF = (quiz) => {
//     const doc = new jsPDF();
//     let y = 15;

//     // Title
//     doc.setFontSize(16);
//     doc.text("Generated Quiz", 10, y);
//     y += 10;
...
//         doc.text("Answer: ________________________________", 14, y);
//         y += 10;
//       }

//       // Fill blank
//       if (q.type === "fill_blank") {
//         doc.text("Answer: ____________", 14, y);
//         y += 10;
//       }
...
//             Turn any PDF into a smart quiz — instantly.
//           </p>
//         </div>
...
//             <label className="block text-sm font-medium text-gray-700 mb-2">
//               Number of Questions:{" "}
//               <span className="text-brand-600">{numQ}</span>
//             </label>
//             <input
//               type="range"
//               min={3}
...
//             disabled={loading}
//             className="w-full mt-3 py-3.5 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-colors disabled:opacity-60"
//           >
//             {loading ? (
//               <>
